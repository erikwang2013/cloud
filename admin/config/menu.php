...
/**
 * Admin panel sidebar menu configuration.
 *
 * Structure:
 *   title    — Chinese display label
 *   key      — Unique identifier; controllers use 'app\\controller\\FooController'
 *   icon     — Layui icon class (e.g. 'layui-icon-username')
 *   href     — URL path for type=1 items
 *   type     — 0 = parent menu group, 1 = clickable menu item
 *   weight   — Sort order (higher = appears first)
 *   children — Nested sub-menus (type=0 only)
 *
 * The business menu (erik_* tables) is auto-generated by generate.php
 * and merged at the top via business_menu.php. System menus follow below.
 */
