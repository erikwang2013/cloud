...
| GET/DELETE | `/api/v1/cdn/domains/{id}` | CDN domain detail / delete |
| POST | `/api/v1/cdn/domains/{id}/purge` | Purge cache (idempotent, up to 100 URLs) |
...
| GET/POST/PUT/DELETE | `/admin/api/v1/providers` | Provider account credentials (shared by CDN/provisioning, Encryptable) |
