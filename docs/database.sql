...
CREATE TABLE erik_user_balances (
    id              BIGINT          NOT NULL PRIMARY KEY,
    user_id         BIGINT          NOT NULL,
    currency        VARCHAR(3)      NOT NULL DEFAULT 'USD',
...
CREATE TABLE erik_refresh_tokens (
    id                  BIGINT          NOT NULL PRIMARY KEY,
    user_id             BIGINT          NOT NULL,
...
CREATE TABLE erik_product_categories (
    id              BIGINT          NOT NULL PRIMARY KEY,
...
CREATE TABLE erik_product_regions (
    id              BIGINT          NOT NULL PRIMARY KEY,
...
CREATE TABLE erik_order_timeline (
    id              BIGINT          NOT NULL PRIMARY KEY,
    order_id        BIGINT          NOT NULL,
...
CREATE TABLE erik_payment_channels (
    id                  BIGINT          NOT NULL PRIMARY KEY,
    name                VARCHAR(128)    NOT NULL,
...
CREATE TABLE erik_payment_transactions (
    id              BIGINT          NOT NULL PRIMARY KEY,
    order_id        BIGINT          NOT NULL,
    user_id         BIGINT          NOT NULL,
...
CREATE TABLE erik_host_machines (
    id                  BIGINT          NOT NULL PRIMARY KEY,
    region_id           BIGINT          NOT NULL,
    name                VARCHAR(255)    NOT NULL,
...
CREATE TABLE erik_ip_allocations (
    id              BIGINT          NOT NULL PRIMARY KEY,
...
CREATE TABLE erik_provision_tasks (
    id              BIGINT          NOT NULL PRIMARY KEY,
    order_id        BIGINT          NOT NULL,
...
CREATE TABLE erik_disk_resizes (
    id              BIGINT          NOT NULL PRIMARY KEY,
...
CREATE TABLE erik_ticket_messages (
    id              BIGINT          NOT NULL PRIMARY KEY,
...
CREATE TABLE erik_supplier_withdraws (
    id              BIGINT          NOT NULL PRIMARY KEY,
    supplier_id     BIGINT          NOT NULL,
...
CREATE TABLE erik_notification_templates (
    id              BIGINT          NOT NULL PRIMARY KEY,
