# Phase 1: 核心交易链路 — Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task.

**Goal:** 实现用户注册登录到支付完成的完整交易闭环。用户可注册、浏览商品、下单、选择支付方式并完成支付。

**Architecture:** 每个模块独立目录 (controller/service/model)，事件驱动 (OrderPaid 事件触发后续流程)，Redis 队列处理异步任务。

**Tech Stack:** PHP 8.2+, webman, Eloquent ORM, Redis, Stripe PHP SDK

---

### Task 1.1: User registration and login

**Files:**
- Create: `service/app/user/controller/AuthController.php`
- Create: `service/app/user/service/AuthService.php`
- Create: `service/app/user/model/User.php`
- Create: `service/app/user/model/RefreshToken.php`
- Create: `tests/User/AuthTest.php`
...
### Task 1.2: Product catalog (list, detail, search)

**Files:**
- Create: `service/app/product/controller/ProductController.php`
- Create: `service/app/product/service/ProductService.php`
- Create: `service/app/product/model/Product.php`
- Create: `service/app/product/model/ProductSku.php`
- Create: `service/app/product/model/Region.php`

- [ ] **Step 1: Create Product model with relations**
...
### Task 1.3: Shopping cart and order creation

**Files:**
- Create: `service/app/order/controller/CartController.php`
- Create: `service/app/order/controller/OrderController.php`
- Create: `service/app/order/service/CartService.php`
- Create: `service/app/order/service/OrderService.php`
- Create: `service/app/order/model/Order.php`
- Create: `service/app/order/model/OrderItem.php`

- [ ] **Step 1: Create Order model and order service (key logic)**
...
### Task 1.4: Payment integration (Stripe + Router)

**Files:**
- Create: `service/app/payment/controller/PaymentController.php`
- Create: `service/app/payment/service/PaymentService.php`
- Create: `service/app/payment/service/PaymentRouter.php`
- Create: `service/app/payment/service/Channels/StripeChannel.php`
- Create: `service/app/payment/service/Channels/CryptoChannel.php`
- Create: `service/app/payment/model/PaymentChannel.php`
- Create: `service/app/payment/model/PaymentTransaction.php`
- Create: `service/app/payment/event/OrderPaid.php`
...
- [ ] **Step 3: Create OrderPaid event and PaymentController**
...
### Task 1.5: Wire routes and test end-to-end

- [ ] **Step 1: Update route config** — `service/config/route.php`
...
**Phase 1 complete.** Users can now: register → login → browse products → add to cart → create order → view payment methods → pay via Stripe. The OrderPaid event fires and is ready for Phase 2 provisioning integration.
