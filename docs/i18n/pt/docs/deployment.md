...
- [ ] `GET /api/v1/products` → 200 (JSON válido)
- [ ] `POST /api/v1/auth/login` (sem body) → 422 (validação de parâmetros)
- [ ] `GET /api/v1/user/profile` (sem token) → 401 (autenticação)
- [ ] Validação de versão: `curl /api/v99/products` → 400
