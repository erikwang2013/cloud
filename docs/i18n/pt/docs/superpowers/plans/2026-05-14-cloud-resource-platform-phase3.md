# Fase 3: Aperfeiçoamento Operacional — Plano de Implementação
...
**Objetivo:** sistema de tickets, notificações, monitoramento e alertas, páginas do painel administrativo, esqueleto dos aplicativos cliente e configuração de implantação. A plataforma atinge o estado de operação oficial.

**Arquitetura:** tickets/notificações distribuídos de forma assíncrona via eventos + Redis Queue. O painel administrativo é construído sobre o webman-admin. Os aplicativos cliente compartilham a camada de API.

**Stack Tecnológica:** PHP 8.2+, webman-admin, webman redis-queue, Flutter 3.x, HarmonyOS ArkTS, Docker

---

### Tarefa 3.1: Sistema de tickets

**Arquivos:**
- Criar: `service/app/ticket/controller/TicketController.php`
- Criar: `service/app/ticket/service/TicketService.php`
- Criar: `service/app/ticket/model/Ticket.php`
- Criar: `service/app/ticket/model/TicketMessage.php`
- Criar: `service/app/ticket/event/TicketCreated.php`
- Criar: `service/app/ticket/listener/AutoAssignListener.php`

- [ ] **Passo 1: Criar o TicketService**
...
- [ ] **Passo 2: Criar o TicketController**
...
- [ ] **Passo 3: Criar o AutoAssignListener**
...
### Tarefa 3.2: Sistema de notificações

**Arquivos:**
- Criar: `service/app/notification/service/NotificationDispatcher.php`
- Criar: `service/app/notification/queue/EmailSender.php`
- Criar: `service/app/notification/queue/SmsSender.php`
- Criar: `service/app/notification/queue/PushSender.php`
- Criar: `service/app/notification/model/Notification.php`
- Criar: `service/app/notification/model/NotificationTemplate.php`

- [ ] **Passo 1: Criar o NotificationDispatcher**
...
- [ ] **Passo 2: Criar o worker de fila EmailSender**
...
- [ ] **Passo 3: Criar o worker de fila SmsSender**
...
- [ ] **Passo 4: Criar o worker de fila PushSender**
...
### Tarefa 3.3: Monitoramento e alertas

**Arquivos:**
- Criar: `service/app/monitor/controller/MonitorController.php`
- Criar: `service/app/monitor/service/ResourceMonitor.php`
- Criar: `service/app/monitor/service/AlertEngine.php`
- Criar: `service/app/monitor/cron/CollectMetrics.php`
- Criar: `service/app/monitor/cron/CheckExpirations.php`

- [ ] **Passo 1: Criar o ResourceMonitor**
...
- [ ] **Passo 4: Criar o controller do painel de monitoramento admin**
...
### Tarefa 3.4: Painel administrativo (páginas webman-admin)

**Arquivos:**
- Criar: `service/app/admin/controller/DashboardController.php`
- Criar: `service/app/admin/controller/UserController.php`
- Criar: `service/app/admin/controller/ProductController.php`
- Criar: `service/app/admin/controller/OrderController.php`
- Criar: `service/app/admin/controller/PaymentController.php`
- Criar: `service/app/admin/controller/SupplierController.php`

- [ ] **Passo 1: Criar o DashboardController**
...
- [ ] **Passo 2: Criar os controllers admin de gerenciamento de pedidos**
...
### Tarefa 3.5: Esqueleto do aplicativo Flutter

**Arquivos:**
- Criar: estrutura do projeto `apps/flutter/`
- Criar: `apps/flutter/lib/core/` (network, auth, i18n, theme)
- Criar: `apps/flutter/lib/features/` (auth, products, orders, resources)

- [ ] **Passo 1: Inicializar o projeto Flutter**

```bash
cd apps && flutter create --org com.cloudplatform --project-name cloud_platform flutter
```

- [ ] **Passo 2: Criar a camada de rede core** — `apps/flutter/lib/core/network/api_client.dart`
...
- [ ] **Passo 3: Criar a estrutura de features**
...
### Tarefa 3.6: Esqueleto do aplicativo HarmonyOS

**Arquivos:**
- Criar: estrutura do projeto `apps/harmonyos/`

- [ ] **Passo 1: Criar a estrutura do projeto HarmonyOS**
...
- [ ] **Passo 2: Criar o ApiClient (ArkTS)**
...
### Tarefa 3.8: Serviço de relatórios

**Arquivos:**
- Criar: `service/app/report/service/ReportService.php`
- Criar: `service/app/report/controller/ReportController.php`

- [ ] **Passo 1: Criar o ReportService**
...
### Tarefa 3.9: Integração final — registrar todas as rotas, filas e eventos

- [ ] **Passo 1: Completar a configuração de rotas** — `service/config/route.php`
...
- [ ] **Passo 2: Registrar os consumidores de fila na configuração**
...
- [ ] **Passo 3: Registrar os listeners de eventos no start.php**
...
**Fase 3 concluída. A plataforma está totalmente operacional:**
- Usuários: registrar → navegar → pedir → pagar → provisionamento automático → gerenciar recursos → abrir tickets
- Admin: dashboard → gerenciar usuários/produtos/pedidos/pagamentos → revisar KYC → tratar tickets → ver relatórios
- Fornecedor: aplicar → ser aprovado → listar produtos → receber liquidações → sacar
- Monitoramento: coleta de métricas a cada 5 minutos, alertas em falhas/expirações
- Implantação: inicialização com um comando via Docker Compose
