# Fase 2: Entrega de Recursos — Plano de Implementação
...
**Objetivo:** implementar a abertura automática de recursos após o pagamento, gerenciamento de domínios, e o onboarding e gerenciamento de fornecedores. A API do Proxmox controla a criação/gerenciamento de VMs, IPs e discos em máquinas físicas.

**Arquitetura:** arquitetura de plugins de provedores (interface ResourceProvider), Worker assíncrono que polla provision_tasks, orientado a eventos (OrderPaid → ProvisioningService → ProviderFactory → ProxmoxProvider/AwsProvider/etc).

**Stack Tecnológica:** PHP 8.2+, webman redis-queue, API REST do Proxmox VE, cliente HTTP Guzzle

---

### Tarefa 2.1: Núcleo do mecanismo de provisionamento

**Arquivos:**
- Criar: `service/app/provisioning/service/ProvisioningService.php`
- Criar: `service/app/provisioning/service/ProviderFactory.php`
- Criar: `service/app/provisioning/service/ProviderInterface.php`
- Criar: `service/app/provisioning/model/Resource.php`
- Criar: `service/app/provisioning/model/ProvisionTask.php`
- Criar: `service/app/provisioning/listener/OrderPaidListener.php`
- Criar: `service/app/provisioning/queue/ProvisionWorker.php`

- [ ] **Passo 1: Criar a ProviderInterface**
...
- [ ] **Passo 2: Criar o ProvisionResult e o ResourceStatus**
...
- [ ] **Passo 3: Criar a ProviderFactory**
...
- [ ] **Passo 4: Criar o ProvisioningService**
...
- [ ] **Passo 5: Criar o OrderPaidListener**
...
- [ ] **Passo 6: Criar o ProvisionWorker (job de fila)**
...
### Tarefa 2.2: Implementação do ProxmoxProvider

**Arquivos:**
- Criar: `service/app/provisioning/provider/ProxmoxApi.php`
- Criar: `service/app/provisioning/provider/ProxmoxProvider.php`
- Criar: `service/app/provisioning/provider/HostSelector.php`
- Criar: `service/app/provisioning/model/HostMachine.php`
- Criar: `service/app/provisioning/model/IpPool.php`

- [ ] **Passo 1: Criar o cliente HTTP ProxmoxApi**
...
- [ ] **Passo 3: Criar o ProxmoxProvider**
...
### Tarefa 2.3: Serviço de domínios

**Arquivos:**
- Criar: `service/app/domain/controller/DomainController.php`
- Criar: `service/app/domain/service/DomainService.php`
- Criar: `service/app/domain/model/DomainTld.php`
- Criar: `service/app/domain/model/DnsZone.php`
- Criar: `service/app/domain/model/DnsRecord.php`

- [ ] **Passo 1: Criar o DomainService (métodos principais)**
...
### Tarefa 2.4: Sistema de fornecedores

**Arquivos:**
- Criar: `service/app/supplier/controller/SupplierController.php`
- Criar: `service/app/supplier/service/SupplierService.php`
- Criar: `service/app/supplier/model/Supplier.php`
- Criar: `service/app/supplier/model/SupplierSettlement.php`

- [ ] **Passo 1: Criar o SupplierService (lógica de negócio principal)**
...
### Tarefa 2.5: Registrar as rotas da Fase 2 e a fila

- [ ] **Passo 1: Atualizar a configuração de rotas**
...
- [ ] **Passo 2: Registrar o ProvisionWorker na configuração da fila**
...
**Fase 2 concluída.** O pagamento agora dispara o provisionamento automático de recursos via Proxmox (ou APIs de nuvem de terceiros). Os usuários podem gerenciar seus recursos, domínios e DNS. Fornecedores podem se cadastrar, listar produtos e receber liquidações.
