# Phase 2 : Livraison des ressources — Plan d'implémentation
...
**Objectif :** après le paiement, provisionner automatiquement les ressources, gérer les domaines, et permettre l'arrivée et la gestion des fournisseurs. L'API Proxmox contrôle les machines physiques pour créer/gérer les VM, les IP et les disques.

**Architecture :** architecture de plugins Provider (interface ResourceProvider), Worker asynchrone interrogeant provision_tasks, piloté par événements (OrderPaid → ProvisioningService → ProviderFactory → ProxmoxProvider/AwsProvider/etc).

**Pile technique :** PHP 8.2+, webman redis-queue, API REST Proxmox VE, client HTTP Guzzle

---

### Tâche 2.1 : Moteur de provisioning central

**Fichiers :**
- Créer : `service/app/provisioning/service/ProvisioningService.php`
- Créer : `service/app/provisioning/service/ProviderFactory.php`
- Créer : `service/app/provisioning/service/ProviderInterface.php`
- Créer : `service/app/provisioning/model/Resource.php`
- Créer : `service/app/provisioning/model/ProvisionTask.php`
- Créer : `service/app/provisioning/listener/OrderPaidListener.php`
- Créer : `service/app/provisioning/queue/ProvisionWorker.php`

- [ ] **Étape 1 : Créer ProviderInterface**
...
- [ ] **Étape 2 : Créer ProvisionResult et ResourceStatus**
...
- [ ] **Étape 4 : Créer ProvisioningService**
...
- [ ] **Étape 5 : Créer OrderPaidListener**
...
- [ ] **Étape 6 : Créer ProvisionWorker (tâche de file)**
...
### Tâche 2.2 : Implémentation du fournisseur Proxmox

**Fichiers :**
- Créer : `service/app/provisioning/provider/ProxmoxApi.php`
- Créer : `service/app/provisioning/provider/ProxmoxProvider.php`
- Créer : `service/app/provisioning/provider/HostSelector.php`
- Créer : `service/app/provisioning/model/HostMachine.php`
- Créer : `service/app/provisioning/model/IpPool.php`

- [ ] **Étape 1 : Créer le client HTTP ProxmoxApi**
...
### Tâche 2.3 : Service de domaines

**Fichiers :**
- Créer : `service/app/domain/controller/DomainController.php`
- Créer : `service/app/domain/service/DomainService.php`
- Créer : `service/app/domain/model/DomainTld.php`
- Créer : `service/app/domain/model/DnsZone.php`
- Créer : `service/app/domain/model/DnsRecord.php`

- [ ] **Étape 1 : Créer DomainService (méthodes clés)**
...
### Tâche 2.4 : Système de fournisseurs

**Fichiers :**
- Créer : `service/app/supplier/controller/SupplierController.php`
- Créer : `service/app/supplier/service/SupplierService.php`
- Créer : `service/app/supplier/model/Supplier.php`
- Créer : `service/app/supplier/model/SupplierSettlement.php`

- [ ] **Étape 1 : Créer SupplierService (logique métier clé)**
...
### Tâche 2.5 : Câbler les routes de la Phase 2 et enregistrer la file
...
- [ ] **Étape 2 : Enregistrer ProvisionWorker dans la configuration de la file**
...
**Phase 2 terminée.** Le paiement déclenche désormais le provisionnement automatique des ressources via Proxmox (ou les API cloud tierces). Les utilisateurs peuvent gérer leurs ressources, leurs domaines et leur DNS. Les fournisseurs peuvent s'inscrire, mettre en ligne leurs produits et recevoir leurs règlements.
