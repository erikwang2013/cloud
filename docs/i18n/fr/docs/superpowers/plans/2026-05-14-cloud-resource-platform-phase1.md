# Phase 1 : Chaîne de transactions cœur — Plan d'implémentation
...
**Objectif :** mettre en place la boucle de transaction complète, de l'inscription/connexion de l'utilisateur au paiement. L'utilisateur peut s'inscrire, parcourir les produits, passer une commande, choisir un moyen de paiement et finaliser le paiement.

**Architecture :** chaque module dispose de son propre répertoire (controller/service/model), piloté par événements (l'événement OrderPaid déclenche les étapes suivantes), avec une file Redis pour les tâches asynchrones.

**Pile technique :** PHP 8.2+, webman, Eloquent ORM, Redis, Stripe PHP SDK

---

### Tâche 1.1 : Inscription et connexion des utilisateurs

**Fichiers :**
- Créer : `service/app/user/controller/AuthController.php`
- Créer : `service/app/user/service/AuthService.php`
- Créer : `service/app/user/model/User.php`
- Créer : `service/app/user/model/RefreshToken.php`
- Créer : `tests/User/AuthTest.php`
...
### Tâche 1.2 : Catalogue de produits (liste, détail, recherche)

**Fichiers :**
- Créer : `service/app/product/controller/ProductController.php`
- Créer : `service/app/product/service/ProductService.php`
- Créer : `service/app/product/model/Product.php`
- Créer : `service/app/product/model/ProductSku.php`
- Créer : `service/app/product/model/Region.php`

- [ ] **Étape 1 : Créer le modèle Product avec ses relations**
...
- [ ] **Étape 3 : Créer ProductController**
...
### Tâche 1.3 : Panier et création de commande

**Fichiers :**
- Créer : `service/app/order/controller/CartController.php`
- Créer : `service/app/order/controller/OrderController.php`
- Créer : `service/app/order/service/CartService.php`
- Créer : `service/app/order/service/OrderService.php`
- Créer : `service/app/order/model/Order.php`
- Créer : `service/app/order/model/OrderItem.php`

- [ ] **Étape 1 : Créer le modèle Order et le service de commande (logique clé)**
...
### Tâche 1.4 : Intégration du paiement (Stripe + routeur)

**Fichiers :**
- Créer : `service/app/payment/controller/PaymentController.php`
- Créer : `service/app/payment/service/PaymentService.php`
- Créer : `service/app/payment/service/PaymentRouter.php`
- Créer : `service/app/payment/service/Channels/StripeChannel.php`
- Créer : `service/app/payment/service/Channels/CryptoChannel.php`
- Créer : `service/app/payment/model/PaymentChannel.php`
- Créer : `service/app/payment/model/PaymentTransaction.php`
- Créer : `service/app/payment/event/OrderPaid.php`

- [ ] **Étape 1 : Créer PaymentRouter**
...
- [ ] **Étape 3 : Créer l'événement OrderPaid et PaymentController**
...
### Tâche 1.5 : Câbler les routes et tester de bout en bout

- [ ] **Étape 1 : Mettre à jour la configuration des routes** — `service/config/route.php`
...
- [ ] **Étape 2 : Script de test manuel de bout en bout**
...
**Phase 1 terminée.** Les utilisateurs peuvent désormais : s'inscrire → se connecter → parcourir les produits → ajouter au panier → créer une commande → consulter les moyens de paiement → payer via Stripe. L'événement OrderPaid se déclenche et est prêt pour l'intégration de la livraison de la Phase 2.
