# Phase 1: Rantai Transaksi Inti — Implementation Plan

> **Untuk agen agentic:** SUB-SKILL WAJIB: Gunakan superpowers:subagent-driven-development (direkomendasikan) atau superpowers:executing-plans untuk mengimplementasikan rencana ini tugas-per-tugas.

**Tujuan:** Mewujudkan loop transaksi lengkap dari registrasi login pengguna hingga penyelesaian pembayaran. Pengguna dapat mendaftar, menjelajahi produk, membuat pesanan, memilih metode pembayaran, dan menyelesaikan pembayaran.

**Arsitektur:** Setiap modul memiliki direktori independen (controller/service/model), event-driven (event OrderPaid memicu alur berikutnya), Redis Queue menangani tugas asinkron.

**Tech Stack:** PHP 8.2+, webman, Eloquent ORM, Redis, Stripe PHP SDK

---

### Tugas 1.1: Registrasi dan login pengguna

**File:**
- Buat: `service/app/user/controller/AuthController.php`
- Buat: `service/app/user/service/AuthService.php`
- Buat: `service/app/user/model/User.php`
- Buat: `service/app/user/model/RefreshToken.php`
- Buat: `tests/User/AuthTest.php`
...
### Tugas 1.2: Katalog produk (daftar, detail, pencarian)

**File:**
- Buat: `service/app/product/controller/ProductController.php`
- Buat: `service/app/product/service/ProductService.php`
- Buat: `service/app/product/model/Product.php`
- Buat: `service/app/product/model/ProductSku.php`
- Buat: `service/app/product/model/Region.php`

- [ ] **Langkah 1: Buat model Product dengan relasi**
...
- [ ] **Langkah 3: Buat ProductController**
...
### Tugas 1.3: Keranjang belanja dan pembuatan pesanan

**File:**
- Buat: `service/app/order/controller/CartController.php`
- Buat: `service/app/order/controller/OrderController.php`
- Buat: `service/app/order/service/CartService.php`
- Buat: `service/app/order/service/OrderService.php`
- Buat: `service/app/order/model/Order.php`
- Buat: `service/app/order/model/OrderItem.php`

- [ ] **Langkah 1: Buat model Order dan order service (logika kunci)**
...
- [ ] **Langkah 2: Buat OrderController**
...
### Tugas 1.4: Integrasi pembayaran (Stripe + Router)

**File:**
- Buat: `service/app/payment/controller/PaymentController.php`
- Buat: `service/app/payment/service/PaymentService.php`
- Buat: `service/app/payment/service/PaymentRouter.php`
- Buat: `service/app/payment/service/Channels/StripeChannel.php`
- Buat: `service/app/payment/service/Channels/CryptoChannel.php`
- Buat: `service/app/payment/model/PaymentChannel.php`
- Buat: `service/app/payment/model/PaymentTransaction.php`
- Buat: `service/app/payment/event/OrderPaid.php`

- [ ] **Langkah 1: Buat PaymentRouter**
...
- [ ] **Langkah 3: Buat event OrderPaid dan PaymentController**
...
### Tugas 1.5: Hubungkan route dan uji end-to-end

- [ ] **Langkah 1: Perbarui konfigurasi route** — `service/config/route.php`
...
- [ ] **Langkah 2: Script uji end-to-end manual**
...
**Phase 1 selesai.** Pengguna kini dapat: registrasi → login → menjelajahi produk → menambah ke keranjang → membuat pesanan → melihat metode pembayaran → membayar melalui Stripe. Event OrderPaid terpicu dan siap untuk integrasi provisioning Phase 2.
