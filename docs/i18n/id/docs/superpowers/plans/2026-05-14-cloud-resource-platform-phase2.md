# Phase 2: Pengiriman Sumber Daya — Rencana Implementasi
...
**Tujuan:** Mengimplementasikan aktivasi sumber daya otomatis setelah pembayaran, manajemen domain, serta pendaftaran dan pengelolaan pemasok. API Proxmox mengontrol pembuatan/pengelolaan VM, IP, dan disk pada mesin fisik.

**Arsitektur:** Arsitektur plugin Provider (interface ResourceProvider), Worker asinkron memproses antrean provision_tasks, berbasis peristiwa (OrderPaid → ProvisioningService → ProviderFactory → ProxmoxProvider/AwsProvider/dll).

**Tech Stack:** PHP 8.2+, webman redis-queue, Proxmox VE REST API, Guzzle HTTP client

---

### Task 2.1: Inti mesin provisioning

**Berkas:**
- Buat: `service/app/provisioning/service/ProvisioningService.php`
- Buat: `service/app/provisioning/service/ProviderFactory.php`
- Buat: `service/app/provisioning/service/ProviderInterface.php`
- Buat: `service/app/provisioning/model/Resource.php`
- Buat: `service/app/provisioning/model/ProvisionTask.php`
- Buat: `service/app/provisioning/listener/OrderPaidListener.php`
- Buat: `service/app/provisioning/queue/ProvisionWorker.php`

- [ ] **Langkah 1: Buat ProviderInterface**
...
- [ ] **Langkah 2: Buat ProvisionResult dan ResourceStatus**
...
- [ ] **Langkah 3: Buat ProviderFactory**
...
- [ ] **Langkah 4: Buat ProvisioningService**
...
- [ ] **Langkah 5: Buat OrderPaidListener**
...
- [ ] **Langkah 6: Buat ProvisionWorker (pekerjaan antrean)**
...
### Task 2.2: Implementasi Provider Proxmox

**Berkas:**
- Buat: `service/app/provisioning/provider/ProxmoxApi.php`
- Buat: `service/app/provisioning/provider/ProxmoxProvider.php`
- Buat: `service/app/provisioning/provider/HostSelector.php`
- Buat: `service/app/provisioning/model/HostMachine.php`
- Buat: `service/app/provisioning/model/IpPool.php`

- [ ] **Langkah 1: Buat klien HTTP ProxmoxApi**
...
- [ ] **Langkah 3: Buat ProxmoxProvider**
...
### Task 2.3: Layanan domain

**Berkas:**
- Buat: `service/app/domain/controller/DomainController.php`
- Buat: `service/app/domain/service/DomainService.php`
- Buat: `service/app/domain/model/DomainTld.php`
- Buat: `service/app/domain/model/DnsZone.php`
- Buat: `service/app/domain/model/DnsRecord.php`

- [ ] **Langkah 1: Buat DomainService (metode-metode kunci)**
...
### Task 2.4: Sistem pemasok

**Berkas:**
- Buat: `service/app/supplier/controller/SupplierController.php`
- Buat: `service/app/supplier/service/SupplierService.php`
- Buat: `service/app/supplier/model/Supplier.php`
- Buat: `service/app/supplier/model/SupplierSettlement.php`

- [ ] **Langkah 1: Buat SupplierService (logika bisnis kunci)**
...
### Task 2.5: Hubungkan rute Phase 2 dan daftarkan antrean
...
- [ ] **Langkah 2: Daftarkan ProvisionWorker di konfigurasi antrean**
...
**Phase 2 selesai.** Pembayaran kini memicu aktivasi sumber daya otomatis melalui Proxmox (atau API cloud pihak ketiga). Pengguna dapat mengelola sumber daya, domain, dan DNS mereka. Pemasok dapat mendaftar, memasang produk, dan menerima settlement.
