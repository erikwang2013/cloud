# Phase 3: Penyempurnaan Operasional — Rencana Implementasi

> **Untuk pekerja agen:** SUB-KEAHLIAN WAJIB: Gunakan superpowers:subagent-driven-development (disarankan) atau superpowers:executing-plans untuk mengimplementasikan rencana ini tugas demi tugas.

**Tujuan:** Sistem tiket, notifikasi pesan, pemantauan dan peringatan, halaman admin, kerangka aplikasi klien, serta konfigurasi deployment. Platform mencapai status siap beroperasi secara resmi.

**Arsitektur:** Tiket/notifikasi didistribusikan asinkron melalui event-driven + Redis Queue. Admin dibangun di atas webman-admin. Aplikasi klien berbagi lapisan API yang sama.

**Tech Stack:** PHP 8.2+, webman-admin, webman redis-queue, Flutter 3.x, HarmonyOS ArkTS, Docker

---

### Task 3.1: Sistem tiket

**Berkas:**
- Buat: `service/app/ticket/controller/TicketController.php`
- Buat: `service/app/ticket/service/TicketService.php`
- Buat: `service/app/ticket/model/Ticket.php`
- Buat: `service/app/ticket/model/TicketMessage.php`
- Buat: `service/app/ticket/event/TicketCreated.php`
- Buat: `service/app/ticket/listener/AutoAssignListener.php`

- [ ] **Langkah 1: Buat TicketService**
...
- [ ] **Langkah 2: Buat TicketController**
...
- [ ] **Langkah 3: Buat AutoAssignListener**
...
### Task 3.2: Sistem notifikasi

**Berkas:**
- Buat: `service/app/notification/service/NotificationDispatcher.php`
- Buat: `service/app/notification/queue/EmailSender.php`
- Buat: `service/app/notification/queue/SmsSender.php`
- Buat: `service/app/notification/queue/PushSender.php`
- Buat: `service/app/notification/model/Notification.php`
- Buat: `service/app/notification/model/NotificationTemplate.php`

- [ ] **Langkah 1: Buat NotificationDispatcher**
...
- [ ] **Langkah 2: Buat worker antrean EmailSender**
...
- [ ] **Langkah 3: Buat worker antrean SmsSender**
...
- [ ] **Langkah 4: Buat worker antrean PushSender**
...
### Task 3.3: Pemantauan dan peringatan

**Berkas:**
- Buat: `service/app/monitor/controller/MonitorController.php`
- Buat: `service/app/monitor/service/ResourceMonitor.php`
- Buat: `service/app/monitor/service/AlertEngine.php`
- Buat: `service/app/monitor/cron/CollectMetrics.php`
- Buat: `service/app/monitor/cron/CheckExpirations.php`

- [ ] **Langkah 1: Buat ResourceMonitor**
...
- [ ] **Langkah 4: Buat controller dasbor pemantauan admin**
...
### Task 3.4: Admin (halaman webman-admin)

**Berkas:**
- Buat: `service/app/admin/controller/DashboardController.php`
- Buat: `service/app/admin/controller/UserController.php`
- Buat: `service/app/admin/controller/ProductController.php`
- Buat: `service/app/admin/controller/OrderController.php`
- Buat: `service/app/admin/controller/PaymentController.php`
- Buat: `service/app/admin/controller/SupplierController.php`

- [ ] **Langkah 1: Buat DashboardController**
...
- [ ] **Langkah 2: Buat controller admin manajemen Pesanan**
...
### Task 3.5: Kerangka aplikasi Flutter

**Berkas:**
- Buat: struktur proyek `apps/flutter/`
- Buat: `apps/flutter/lib/core/` (network, auth, i18n, theme)
- Buat: `apps/flutter/lib/features/` (auth, products, orders, resources)
...
- [ ] **Langkah 2: Buat lapisan network inti** — `apps/flutter/lib/core/network/api_client.dart`
...
### Task 3.6: Kerangka aplikasi HarmonyOS

**Berkas:**
- Buat: struktur proyek `apps/harmonyos/`

- [ ] **Langkah 1: Buat struktur proyek HarmonyOS**
...
- [ ] **Langkah 2: Buat ApiClient (ArkTS)**
...
### Task 3.7: Konfigurasi Docker dan deployment

**Berkas:**
- Buat: `docker/Dockerfile`
- Buat: `docker/docker-compose.yml`
- Buat: `docker/nginx.conf`
- Buat: `docker/supervisor.conf`
- Buat: `service/.env.example`
...
### Task 3.8: Layanan laporan

**Berkas:**
- Buat: `service/app/report/service/ReportService.php`
- Buat: `service/app/report/controller/ReportController.php`

- [ ] **Langkah 1: Buat ReportService**
...
### Task 3.9: Integrasi akhir — hubungkan semua rute, antrean, dan peristiwa

- [ ] **Langkah 1: Lengkapi konfigurasi rute** — `service/config/route.php`
...
- [ ] **Langkah 2: Daftarkan konsumen antrean di konfigurasi**
...
- [ ] **Langkah 3: Daftarkan listener peristiwa di start.php**
...
**Phase 3 selesai. Platform beroperasi penuh:**
- Pengguna: daftar → jelajah → pesan → bayar → aktivasi otomatis → kelola sumber daya → buat tiket
- Admin: dasbor → kelola pengguna/produk/pesanan/pembayaran → tinjau KYC → tangani tiket → lihat laporan
- Pemasok: daftar → disetujui → pasang produk → terima settlement → tarik dana
- Pemantauan: pengumpulan metrik tiap 5 menit, peringatan atas kegagalan/kedaluwarsa
- Deployment: startup satu perintah Docker Compose
