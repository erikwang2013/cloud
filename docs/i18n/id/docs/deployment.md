...
- [ ] `GET /api/v1/products` → 200 (JSON valid)
- [ ] `POST /api/v1/auth/login` (tanpa body) → 422 (validasi parameter)
- [ ] `GET /api/v1/user/profile` (tanpa token) → 401 (autentikasi)
- [ ] Versi tidak valid: `curl /api/v99/products` → 400
