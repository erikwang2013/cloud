...
<p align="center">
  <p align="center">
  <img src="docs/diagrams/c.svg" alt="युनतुआन, CloudPlatform परियोजना का शुभंकर" width="260">
</p>

<p align="center">**युनतुआन** — परियोजना का शुभंकर</p>
</p>
...
- **उपयोगकर्ता पोर्टल**: API सेवा (डिफ़ॉल्ट `http://localhost:8787`) पर जाएं, खाता बनाकर लॉगिन करें। Google / Apple OAuth और TOTP दो-चरणीय प्रमाणीकरण समर्थित है
- **एडमिन पैनल**: ब्राउज़र में `http://localhost:8787/app/admin` खोलें (पैनल अलग इंस्टेंस है, पोर्ट 8788) और इंस्टॉलर द्वारा बनाए गए एडमिन खाते से लॉगिन करें

### एडमिन की सामान्य सुविधाएँ

- **डैशबोर्ड**: आज के ऑर्डर / राजस्व / नए उपयोगकर्ता / सक्रिय संसाधन आँकड़े, 30-दिन राजस्व प्रवृत्ति चार्ट, PDF निर्यात
- **रिपोर्ट केंद्र**: ऑर्डर रिपोर्ट, उत्पाद रैंकिंग, चैनल आँकड़े, उपयोगकर्ता वृद्धि, Excel निर्यात
- **दैनिक प्रबंधन**: उपयोगकर्ता / उत्पाद / ऑर्डर / आपूर्तिकर्ता / टिकट / डोमेन / CDN, KYC समीक्षा, रिफंड, निपटान और निकासी अनुमोदन
- **सिस्टम कॉन्फ़िगरेशन**: भुगतान चैनल, CDN खाते, वेबहुक, नोटिफिकेशन टेम्पलेट, सहायता लेख, ऑडिट लॉग

### क्लाइंट बिल्ड

- **Flutter क्लाइंट** (`apps/flutter/`): iOS / Android / Web / Linux / macOS / Windows समर्थन। `flutter pub get` निर्भरताओं के लिए, `flutter run` डिबगिंग के लिए, `flutter build apk` / `flutter build ios` / `flutter build web` पैकेजिंग के लिए
- **HarmonyOS क्लाइंट** (`apps/harmonyos/`): ArkTS नेटिव ऐप — DevEco Studio से `entry` प्रोजेक्ट खोलकर बिल्ड करें और चलाएं
