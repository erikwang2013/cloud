# चरण 3: परिचालन सुधार — कार्यान्वयन योजना

> **एजेंटिक कार्यकर्ताओं के लिए:** आवश्यक उप-कौशल: इस योजना को कार्य-दर-कार्य लागू करने के लिए superpowers:subagent-driven-development (अनुशंसित) या superpowers:executing-plans का उपयोग करें।

**लक्ष्य:** टिकट प्रणाली, संदेश सूचनाएँ, निगरानी अलर्ट, प्रशासनिक बैकएंड पृष्ठ, क्लाइंट ऐप कंकाल, तैनाती कॉन्फ़िगरेशन। प्लेटफ़ॉर्म औपचारिक रूप से परिचालन योग्य स्थिति तक पहुँचता है।

**आर्किटेक्चर:** टिकट/सूचनाएँ इवेंट-संचालित + Redis Queue के माध्यम से अतुल्यकालिक रूप से वितरित होती हैं। प्रशासनिक बैकएंड webman-admin पर आधारित है। क्लाइंट ऐप साझा API परत का उपयोग करते हैं।

**टेक स्टैक:** PHP 8.2+, webman-admin, webman redis-queue, Flutter 3.x, HarmonyOS ArkTS, Docker

---

### कार्य 3.1: टिकट प्रणाली

**फ़ाइलें:**
- बनाएँ: `service/app/ticket/controller/TicketController.php`
- बनाएँ: `service/app/ticket/service/TicketService.php`
- बनाएँ: `service/app/ticket/model/Ticket.php`
- बनाएँ: `service/app/ticket/model/TicketMessage.php`
- बनाएँ: `service/app/ticket/event/TicketCreated.php`
- बनाएँ: `service/app/ticket/listener/AutoAssignListener.php`

- [ ] **चरण 1: TicketService बनाएँ**
...
- [ ] **चरण 3: AutoAssignListener बनाएँ**
...
### कार्य 3.2: सूचना प्रणाली

**फ़ाइलें:**
- बनाएँ: `service/app/notification/service/NotificationDispatcher.php`
- बनाएँ: `service/app/notification/queue/EmailSender.php`
- बनाएँ: `service/app/notification/queue/SmsSender.php`
- बनाएँ: `service/app/notification/queue/PushSender.php`
- बनाएँ: `service/app/notification/model/Notification.php`
- बनाएँ: `service/app/notification/model/NotificationTemplate.php`

- [ ] **चरण 1: NotificationDispatcher बनाएँ**
...
- [ ] **चरण 2: EmailSender कतार कार्यकर्ता बनाएँ**
...
- [ ] **चरण 3: SmsSender कतार कार्यकर्ता बनाएँ**
...
- [ ] **चरण 4: PushSender कतार कार्यकर्ता बनाएँ**
...
### कार्य 3.3: निगरानी और अलर्ट

**फ़ाइलें:**
- बनाएँ: `service/app/monitor/controller/MonitorController.php`
- बनाएँ: `service/app/monitor/service/ResourceMonitor.php`
- बनाएँ: `service/app/monitor/service/AlertEngine.php`
- बनाएँ: `service/app/monitor/cron/CollectMetrics.php`
- बनाएँ: `service/app/monitor/cron/CheckExpirations.php`

- [ ] **चरण 1: ResourceMonitor बनाएँ**
...
- [ ] **चरण 4: प्रशासनिक निगरानी डैशबोर्ड कंट्रोलर बनाएँ**
...
### कार्य 3.4: प्रशासनिक बैकएंड (webman-admin पृष्ठ)

**फ़ाइलें:**
- बनाएँ: `service/app/admin/controller/DashboardController.php`
- बनाएँ: `service/app/admin/controller/UserController.php`
- बनाएँ: `service/app/admin/controller/ProductController.php`
- बनाएँ: `service/app/admin/controller/OrderController.php`
- बनाएँ: `service/app/admin/controller/PaymentController.php`
- बनाएँ: `service/app/admin/controller/SupplierController.php`

- [ ] **चरण 1: DashboardController बनाएँ**
...
- [ ] **चरण 2: ऑर्डर प्रबंधन प्रशासनिक कंट्रोलर बनाएँ**
...
### कार्य 3.5: Flutter ऐप कंकाल

**फ़ाइलें:**
- बनाएँ: `apps/flutter/` प्रोजेक्ट संरचना
- बनाएँ: `apps/flutter/lib/core/` (network, auth, i18n, theme)
- बनाएँ: `apps/flutter/lib/features/` (auth, products, orders, resources)

- [ ] **चरण 1: Flutter प्रोजेक्ट आरंभ करें**

```bash
cd apps && flutter create --org com.cloudplatform --project-name cloud_platform flutter
```

- [ ] **चरण 2: कोर नेटवर्क परत बनाएँ** — `apps/flutter/lib/core/network/api_client.dart`
...
### कार्य 3.6: HarmonyOS ऐप कंकाल

**फ़ाइलें:**
- बनाएँ: `apps/harmonyos/` प्रोजेक्ट संरचना

- [ ] **चरण 1: HarmonyOS प्रोजेक्ट संरचना बनाएँ**
...
### कार्य 3.7: Docker और तैनाती कॉन्फ़िगरेशन

**फ़ाइलें:**
- बनाएँ: `docker/Dockerfile`
- बनाएँ: `docker/docker-compose.yml`
- बनाएँ: `docker/nginx.conf`
- बनाएँ: `docker/supervisor.conf`
- बनाएँ: `service/.env.example`

- [ ] **चरण 1: Dockerfile बनाएँ**
...
- [ ] **चरण 2: docker-compose.yml बनाएँ**
...
### कार्य 3.8: रिपोर्टिंग सेवा

**फ़ाइलें:**
- बनाएँ: `service/app/report/service/ReportService.php`
- बनाएँ: `service/app/report/controller/ReportController.php`

- [ ] **चरण 1: ReportService बनाएँ**
...
### कार्य 3.9: अंतिम एकीकरण — सभी रूट, कतारें और इवेंट जोड़ें

- [ ] **चरण 1: रूट कॉन्फ़िगरेशन पूर्ण करें** — `service/config/route.php`
...
- [ ] **चरण 2: कॉन्फ़िगरेशन में कतार उपभोक्ता पंजीकृत करें**
...
- [ ] **चरण 3: start.php में इवेंट श्रोता पंजीकृत करें**
...
**चरण 3 पूर्ण। प्लेटफ़ॉर्म पूरी तरह से परिचालन योग्य है:**
- उपयोगकर्ता: पंजीकरण → ब्राउज़ → ऑर्डर → भुगतान → स्वचालित प्रावधान → संसाधन प्रबंधन → टिकट सबमिट करना
- प्रशासक: डैशबोर्ड → उपयोगकर्ता/उत्पाद/ऑर्डर/भुगतान प्रबंधन → KYC समीक्षा → टिकट संभालना → रिपोर्ट देखना
- विक्रेता: आवेदन → अनुमोदन → उत्पाद सूचीबद्ध करना → निपटान प्राप्त करना → निकासी
- निगरानी: 5 मिनट का मेट्रिक्स संग्रह, विफलताओं/समाप्ति पर अलर्ट
- तैनाती: Docker Compose एक-कमांड स्टार्टअप
