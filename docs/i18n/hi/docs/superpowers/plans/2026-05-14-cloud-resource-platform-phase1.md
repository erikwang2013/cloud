# चरण 1: मुख्य लेन-देन श्रृंखला — कार्यान्वयन योजना
...
**लक्ष्य:** उपयोगकर्ता पंजीकरण/लॉगिन से लेकर भुगतान पूर्ण होने तक की पूर्ण लेन-देन बंद लूप को लागू करना। उपयोगकर्ता पंजीकरण कर सकता है, उत्पाद देख सकता है, ऑर्डर दे सकता है, भुगतान विधि चुन सकता है और भुगतान पूर्ण कर सकता है।

**आर्किटेक्चर:** प्रत्येक मॉड्यूल स्वतंत्र निर्देशिका (controller/service/model) में है, इवेंट-संचालित (OrderPaid इवेंट आगे की प्रक्रिया को ट्रिगर करता है), Redis कतार अतुल्यकालिक कार्यों को संसाधित करती है।

**टेक स्टैक:** PHP 8.2+, webman, Eloquent ORM, Redis, Stripe PHP SDK

---

### कार्य 1.1: उपयोगकर्ता पंजीकरण और लॉगिन

**फ़ाइलें:**
- बनाएँ: `service/app/user/controller/AuthController.php`
- बनाएँ: `service/app/user/service/AuthService.php`
- बनाएँ: `service/app/user/model/User.php`
- बनाएँ: `service/app/user/model/RefreshToken.php`
- बनाएँ: `tests/User/AuthTest.php`

- [ ] **चरण 1: User मॉडल बनाएँ**
...
### कार्य 1.2: उत्पाद सूची (सूची, विवरण, खोज)

**फ़ाइलें:**
- बनाएँ: `service/app/product/controller/ProductController.php`
- बनाएँ: `service/app/product/service/ProductService.php`
- बनाएँ: `service/app/product/model/Product.php`
- बनाएँ: `service/app/product/model/ProductSku.php`
- बनाएँ: `service/app/product/model/Region.php`

- [ ] **चरण 1: संबंधों के साथ Product मॉडल बनाएँ**
...
### कार्य 1.3: शॉपिंग कार्ट और ऑर्डर निर्माण

**फ़ाइलें:**
- बनाएँ: `service/app/order/controller/CartController.php`
- बनाएँ: `service/app/order/controller/OrderController.php`
- बनाएँ: `service/app/order/service/CartService.php`
- बनाएँ: `service/app/order/service/OrderService.php`
- बनाएँ: `service/app/order/model/Order.php`
- बनाएँ: `service/app/order/model/OrderItem.php`

- [ ] **चरण 1: Order मॉडल और ऑर्डर सेवा बनाएँ (मुख्य तर्क)**
...
### कार्य 1.4: भुगतान एकीकरण (Stripe + राउटर)

**फ़ाइलें:**
- बनाएँ: `service/app/payment/controller/PaymentController.php`
- बनाएँ: `service/app/payment/service/PaymentService.php`
- बनाएँ: `service/app/payment/service/PaymentRouter.php`
- बनाएँ: `service/app/payment/service/Channels/StripeChannel.php`
- बनाएँ: `service/app/payment/service/Channels/CryptoChannel.php`
- बनाएँ: `service/app/payment/model/PaymentChannel.php`
- बनाएँ: `service/app/payment/model/PaymentTransaction.php`
- बनाएँ: `service/app/payment/event/OrderPaid.php`

- [ ] **चरण 1: PaymentRouter बनाएँ**
...
- [ ] **चरण 3: OrderPaid इवेंट और PaymentController बनाएँ**
...
### कार्य 1.5: रूट जोड़ें और अंत-से-अंत परीक्षण करें

- [ ] **चरण 1: रूट कॉन्फ़िगरेशन अपडेट करें** — `service/config/route.php`
...
- [ ] **चरण 2: मैनुअल अंत-से-अंत परीक्षण स्क्रिप्ट**
...
**चरण 1 पूर्ण।** उपयोगकर्ता अब यह कर सकते हैं: पंजीकरण → लॉगिन → उत्पाद देखना → कार्ट में जोड़ना → ऑर्डर बनाना → भुगतान विधियाँ देखना → Stripe के माध्यम से भुगतान करना। OrderPaid इवेंट ट्रिगर होता है और चरण 2 के प्रावधान (provisioning) एकीकरण के लिए तैयार है।
