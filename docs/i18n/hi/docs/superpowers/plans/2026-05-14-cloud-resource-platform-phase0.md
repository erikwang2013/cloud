# Phase 0: बुनियादी ढाँचा — कार्यान्वयन योजना

> **एजेंटिक वर्करों के लिए:** आवश्यक उप-कौशल: इस योजना को कार्य-दर-कार्य लागू करने के लिए superpowers:subagent-driven-development (अनुशंसित) या superpowers:executing-plans का उपयोग करें। चरण ट्रैकिंग के लिए checkbox (`- [ ]`) सिंटैक्स का उपयोग करते हैं।

**लक्ष्य:** परियोजना स्कैफोल्डिंग, डेटाबेस माइग्रेशन, साझा लाइब्रेरी, प्रमाणीकरण और प्राधिकरण, बहुभाषा बुनियादी ढाँचा, सुरक्षा मिडलवेयर का निर्माण, सभी बाद के चरणों के लिए आधार प्रदान करना।

**आर्किटेक्चर:** webman मॉड्यूलर मोनोलिथ, व्यावसायिक डोमेन के अनुसार अलग-अलग निर्देशिका मॉड्यूल में विभाजित, साझा बुनियादी ढाँचा common/ के अंतर्गत। डेटाबेस MySQL + Eloquent ORM, कैश/कतार Redis।

**टेक स्टैक:** PHP 8.2+, webman 1.6+, illuminate/database, firebase/php-jwt, redis, monolog

---

## फ़ाइल संरचना (इस चरण में)
...
### कार्य 0.1: webman परियोजना और निर्भरताएँ आरंभ करें

**फ़ाइलें:**
- बनाएँ: `service/composer.json`

- [ ] **चरण 1: composer.json बनाएँ**
...
अपेक्षित: सभी पैकेज स्थापित, vendor/ बन गया।

- [ ] **चरण 3: config/app.php बनाएँ**
...
- [ ] **चरण 4: config/database.php बनाएँ**
...
- [ ] **चरण 7: config/security.php बनाएँ**
...
- [ ] **चरण 9: start.php बूटस्ट्रैप बनाएँ**
...
### कार्य 0.2: सभी डेटाबेस माइग्रेशन बनाएँ

**फ़ाइलें:**
- बनाएँ: `service/database/migrations/0001_create_users_tables.php`

- [ ] **चरण 1: users माइग्रेशन बनाएँ**
...
- [ ] **चरण 2: products माइग्रेशन बनाएँ** — `service/database/migrations/0002_create_product_tables.php`
...
- [ ] **चरण 3: orders माइग्रेशन बनाएँ** — `service/database/migrations/0003_create_order_tables.php`
...
- [ ] **चरण 4: माइग्रेशन 0004-0010**

समान पैटर्न का अनुसरण करते हुए शेष माइग्रेशन जारी रखें:
...
प्रत्येक ऊपर दिए गए समान पैटर्न का पालन करता है `Capsule::schema()->create(...)` के साथ।

- [ ] **चरण 5: माइग्रेशन रनर बनाएँ** — `service/database/migrate.php`
...
- [ ] **चरण 6: सभी माइग्रेशन चलाएँ**

चलाएँ: `php service/database/migrate.php`
अपेक्षित: सभी तालिकाएँ सफलतापूर्वक बन गईं।
...
### कार्य 0.3: साझा हेल्पर लाइब्रेरी बनाएँ

**फ़ाइलें:**
- बनाएँ: `service/common/helper/Response.php`
- बनाएँ: `service/common/helper/Validator.php`

- [ ] **चरण 1: Response हेल्पर बनाएँ**
...
### कार्य 0.4: JWT प्रमाणीकरण बनाएँ

**फ़ाइलें:**
- बनाएँ: `service/common/auth/JwtAuth.php`
- बनाएँ: `service/common/auth/middleware/AuthMiddleware.php`
...
### कार्य 0.5: RBAC बनाएँ

**फ़ाइलें:**
- बनाएँ: `service/common/auth/Rbac.php`
- बनाएँ: `service/common/auth/middleware/RbacMiddleware.php`
...
### कार्य 0.6: i18n बुनियादी ढाँचा बनाएँ

**फ़ाइलें:**
- बनाएँ: `service/common/i18n/I18n.php`
- बनाएँ: `service/common/i18n/middleware/LocaleMiddleware.php`
- बनाएँ: `service/i18n/zh-CN/messages.php`
- बनाएँ: `service/i18n/en-US/messages.php`
...
- [ ] **चरण 3: i18n संदेश फ़ाइलें बनाएँ**
...
### कार्य 0.7: सुरक्षा मिडलवेयर बनाएँ

**फ़ाइलें:**
- बनाएँ: `service/common/security/WafMiddleware.php`
- बनाएँ: `service/common/security/RateLimitMiddleware.php`
- बनाएँ: `service/common/security/CorsMiddleware.php`
- बनाएँ: `service/common/security/AuditLogger.php`
- बनाएँ: `service/common/security/LogSanitizer.php`

- [ ] **चरण 1: WafMiddleware बनाएँ**
...
- [ ] **चरण 2: RateLimitMiddleware बनाएँ**
...
### कार्य 0.8: स्वास्थ्य एंडपॉइंट बनाएँ और मिडलवेयर पाइपलाइन पंजीकृत करें

**फ़ाइलें:**
- बनाएँ: `service/app/controller/HealthController.php`
- संशोधित करें: `service/start.php` (मिडलवेयर पंजीकरण)
- संशोधित करें: `service/config/route.php` (यदि मौजूद हो, अन्यथा बनाएँ)
...
- [ ] **चरण 2: start.php में वैश्विक मिडलवेयर पंजीकृत करें**
...
### कार्य 0.9: Phase 0 की पूर्णता सत्यापित करें

- [ ] **चरण 1: webman डेव सर्वर शुरू करें**

चलाएँ: `cd service && php start.php start`
अपेक्षित: सर्वर http://0.0.0.0:8787 पर शुरू होता है

- [ ] **चरण 2: स्वास्थ्य एंडपॉइंट का परीक्षण करें**

चलाएँ: `curl http://localhost:8787/health`
अपेक्षित: `{"code":0,"message":"ok","data":{"status":"healthy",...}}`

- [ ] **चरण 3: दर सीमा का परीक्षण करें**

चलाएँ: `for i in {1..10}; do curl -s http://localhost:8787/health; done`
अपेक्षित: सभी 200 लौटाते हैं (health पर सख्त दर सीमा नहीं है)

- [ ] **चरण 4: WAF का परीक्षण करें**

चलाएँ: `curl -X POST http://localhost:8787/api/auth/login -d "email=test' OR '1'='1"` 
अपेक्षित: `{"code":403,"message":"Request blocked by WAF"}`

- [ ] **चरण 5: DB कनेक्शन सत्यापित करें**

चलाएँ: `php service/database/migrate.php`
अपेक्षित: सभी माइग्रेशन बिना त्रुटि चलते हैं।

- [ ] **चरण 6: लॉक फ़ाइल कमिट करें**
...
**Phase 0 पूर्ण।** आधार तैयार: परियोजना स्कैफोल्ड, 50+ DB तालिकाएँ, JWT प्रमाणीकरण, RBAC, i18n, WAF + दर सीमा + CORS, ऑडिट लॉगिंग।
