# चरण 2: संसाधन वितरण — कार्यान्वयन योजना
...
**लक्ष्य:** भुगतान के बाद संसाधनों का स्वचालित प्रावधान (provisioning), डोमेन प्रबंधन, विक्रेता (supplier) पंजीकरण और प्रबंधन लागू करना। Proxmox API भौतिक मशीन पर VM, IP, डिस्क के निर्माण/प्रबंधन को नियंत्रित करता है।

**आर्किटेक्चर:** Provider प्लगइन आर्किटेक्चर (ResourceProvider interface), अतुल्यकालिक Worker provision_tasks को पोल करता है, इवेंट-संचालित (OrderPaid → ProvisioningService → ProviderFactory → ProxmoxProvider/AwsProvider/आदि)।

**टेक स्टैक:** PHP 8.2+, webman redis-queue, Proxmox VE REST API, Guzzle HTTP client

---

### कार्य 2.1: प्रावधान इंजन कोर

**फ़ाइलें:**
- बनाएँ: `service/app/provisioning/service/ProvisioningService.php`
- बनाएँ: `service/app/provisioning/service/ProviderFactory.php`
- बनाएँ: `service/app/provisioning/service/ProviderInterface.php`
- बनाएँ: `service/app/provisioning/model/Resource.php`
- बनाएँ: `service/app/provisioning/model/ProvisionTask.php`
- बनाएँ: `service/app/provisioning/listener/OrderPaidListener.php`
- बनाएँ: `service/app/provisioning/queue/ProvisionWorker.php`

- [ ] **चरण 1: ProviderInterface बनाएँ**
...
- [ ] **चरण 2: ProvisionResult और ResourceStatus बनाएँ**
...
- [ ] **चरण 4: ProvisioningService बनाएँ**
...
- [ ] **चरण 6: ProvisionWorker बनाएँ (कतार कार्य)**
...
### कार्य 2.2: Proxmox Provider कार्यान्वयन

**फ़ाइलें:**
- बनाएँ: `service/app/provisioning/provider/ProxmoxApi.php`
- बनाएँ: `service/app/provisioning/provider/ProxmoxProvider.php`
- बनाएँ: `service/app/provisioning/provider/HostSelector.php`
- बनाएँ: `service/app/provisioning/model/HostMachine.php`
- बनाएँ: `service/app/provisioning/model/IpPool.php`

- [ ] **चरण 1: ProxmoxApi HTTP क्लाइंट बनाएँ**
...
### कार्य 2.3: डोमेन सेवा

**फ़ाइलें:**
- बनाएँ: `service/app/domain/controller/DomainController.php`
- बनाएँ: `service/app/domain/service/DomainService.php`
- बनाएँ: `service/app/domain/model/DomainTld.php`
- बनाएँ: `service/app/domain/model/DnsZone.php`
- बनाएँ: `service/app/domain/model/DnsRecord.php`

- [ ] **चरण 1: DomainService बनाएँ (मुख्य विधियाँ)**
...
### कार्य 2.4: विक्रेता प्रणाली

**फ़ाइलें:**
- बनाएँ: `service/app/supplier/controller/SupplierController.php`
- बनाएँ: `service/app/supplier/service/SupplierService.php`
- बनाएँ: `service/app/supplier/model/Supplier.php`
- बनाएँ: `service/app/supplier/model/SupplierSettlement.php`

- [ ] **चरण 1: SupplierService बनाएँ (मुख्य व्यावसायिक तर्क)**
...
### कार्य 2.5: चरण 2 रूट जोड़ें और कतार पंजीकृत करें
...
- [ ] **चरण 2: कतार कॉन्फ़िगरेशन में ProvisionWorker पंजीकृत करें**
...
**चरण 2 पूर्ण।** भुगतान अब Proxmox (या तीसरे पक्ष के क्लाउड API) के माध्यम से स्वचालित संसाधन प्रावधान को ट्रिगर करता है। उपयोगकर्ता अपने संसाधनों, डोमेन और DNS का प्रबंधन कर सकते हैं। विक्रेता पंजीकरण कर सकते हैं, उत्पाद सूचीबद्ध कर सकते हैं और निपटान (settlement) प्राप्त कर सकते हैं।
