...
│   │   ├── version/middleware/  # API ভার্সন মিডলওয়্যার (X-Api-Version হেডার ভ্যালিডেশন)
...
- **Version** — `X-Api-Version` রিকোয়েস্ট হেডার ভ্যালিডেট করে, অনুপস্থিত থাকলে ডিফল্ট `v1`, অসমর্থিত ভার্সনে `400` রিটার্ন
