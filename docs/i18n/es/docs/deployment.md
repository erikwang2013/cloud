...
- [ ] `POST /api/v1/auth/login` (sin body) → 422 (validación de parámetros)
- [ ] `GET /api/v1/user/profile` (sin token) → 401 (autenticación)
- [ ] Versión en la URL: `curl .../api/v1/products` → 200
