# Fase 2: Entrega de recursos — Plan de implementación
...
**Objetivo:** implementar la activación automática de recursos tras el pago, la gestión de dominios y la incorporación y gestión de proveedores. La API de Proxmox controla la creación/gestión de VM, IP y discos en los servidores físicos.

**Arquitectura:** arquitectura de plugins Provider (interfaz ResourceProvider), Worker asíncrono que sondea provision_tasks, dirigido por eventos (OrderPaid → ProvisioningService → ProviderFactory → ProxmoxProvider/AwsProvider/etc).

**Stack tecnológico:** PHP 8.2+, webman redis-queue, Proxmox VE REST API, cliente HTTP Guzzle

---

### Tarea 2.1: Núcleo del motor de aprovisionamiento

**Archivos:**
- Crear: `service/app/provisioning/service/ProvisioningService.php`
- Crear: `service/app/provisioning/service/ProviderFactory.php`
- Crear: `service/app/provisioning/service/ProviderInterface.php`
- Crear: `service/app/provisioning/model/Resource.php`
- Crear: `service/app/provisioning/model/ProvisionTask.php`
- Crear: `service/app/provisioning/listener/OrderPaidListener.php`
- Crear: `service/app/provisioning/queue/ProvisionWorker.php`

- [ ] **Paso 1: Crear ProviderInterface**
...
- [ ] **Paso 2: Crear ProvisionResult y ResourceStatus**
...
- [ ] **Paso 4: Crear ProvisioningService**
...
- [ ] **Paso 5: Crear OrderPaidListener**
...
- [ ] **Paso 6: Crear ProvisionWorker (trabajo de cola)**
...
### Tarea 2.2: Implementación del Provider Proxmox

**Archivos:**
- Crear: `service/app/provisioning/provider/ProxmoxApi.php`
- Crear: `service/app/provisioning/provider/ProxmoxProvider.php`
- Crear: `service/app/provisioning/provider/HostSelector.php`
- Crear: `service/app/provisioning/model/HostMachine.php`
- Crear: `service/app/provisioning/model/IpPool.php`

- [ ] **Paso 1: Crear el cliente HTTP ProxmoxApi**
...
### Tarea 2.3: Servicio de dominios

**Archivos:**
- Crear: `service/app/domain/controller/DomainController.php`
- Crear: `service/app/domain/service/DomainService.php`
- Crear: `service/app/domain/model/DomainTld.php`
- Crear: `service/app/domain/model/DnsZone.php`
- Crear: `service/app/domain/model/DnsRecord.php`

- [ ] **Paso 1: Crear DomainService (métodos clave)**
...
### Tarea 2.4: Sistema de proveedores

**Archivos:**
- Crear: `service/app/supplier/controller/SupplierController.php`
- Crear: `service/app/supplier/service/SupplierService.php`
- Crear: `service/app/supplier/model/Supplier.php`
- Crear: `service/app/supplier/model/SupplierSettlement.php`

- [ ] **Paso 1: Crear SupplierService (lógica de negocio clave)**
...
### Tarea 2.5: Cableado de las rutas de la Fase 2 y registro de la cola
...
- [ ] **Paso 2: Registrar ProvisionWorker en la configuración de colas**
...
**Fase 2 completa.** El pago ahora desencadena el aprovisionamiento automático de recursos mediante Proxmox (o API de nubes de terceros). Los usuarios pueden gestionar sus recursos, dominios y DNS. Los proveedores pueden incorporarse, publicar productos y recibir liquidaciones.
