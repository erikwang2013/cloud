...
// domain_tlds
if (!Capsule::schema()->hasTable('domain_tlds')) {
...
// domain_transfers
if (!Capsule::schema()->hasTable('domain_transfers')) {
...
// dns_zones
if (!Capsule::schema()->hasTable('dns_zones')) {
...
// dns_records
if (!Capsule::schema()->hasTable('dns_records')) {
