...
// resource_servers
if (!Capsule::schema()->hasTable('resource_servers')) {
...
// resource_ips
if (!Capsule::schema()->hasTable('resource_ips')) {
...
// resource_disks
if (!Capsule::schema()->hasTable('resource_disks')) {
...
// resource_domains
if (!Capsule::schema()->hasTable('resource_domains')) {
...
// provision_tasks
if (!Capsule::schema()->hasTable('provision_tasks')) {
...
// provider_apis
if (!Capsule::schema()->hasTable('provider_apis')) {
